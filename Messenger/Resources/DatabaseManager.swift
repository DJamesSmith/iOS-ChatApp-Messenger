...
//  Messenger
//
//  Created by Dion James Smith on 12/10/23.
//
...
extension DatabaseManager {
    ...
    /// - `completion`:      Aaync closure to return with result
...
// MARK: Entension - Sending messages / conversations
extension DatabaseManager {
    // MARK: createNewConversation - Creates a new conversation with target user email and first message sent
...
//        }
    ...
    // MARK: getAllConversations - Fetches and returns all conversations for the user with passed in email
    ...
    // MARK: getAllMessagesForConversation - Gets all messages for a given conversation
...
struct ChatAppUser {
    ...
    var profilePictureFileName: String {
        // dummyacctdion-gmail-com_profile_picture.png
